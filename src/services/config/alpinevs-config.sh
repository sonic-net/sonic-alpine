...
if [ -f /etc/sonic/config_db.json ]; then
    ...
    *)
    ...
    echo "Setting port id for "${platform}""
    redis-cli -n 4 hmset "PORT|Ethernet0" "id" "1"
    redis-cli -n 4 hmset "PORT|Ethernet4" "id" "2"
    redis-cli -n 4 hmset "PORT|Ethernet8" "id" "3"
    redis-cli -n 4 hmset "PORT|Ethernet12" "id" "4"
    redis-cli -n 4 hmset "PORT|Ethernet16" "id" "5"
    redis-cli -n 4 hmset "PORT|Ethernet20" "id" "6"
    redis-cli -n 4 hmset "PORT|Ethernet24" "id" "7"
    redis-cli -n 4 hmset "PORT|Ethernet28" "id" "8"
    redis-cli -n 4 hmset "PORT|Ethernet32" "id" "9"
    redis-cli -n 4 hmset "PORT|Ethernet36" "id" "10"
    redis-cli -n 4 hmset "PORT|Ethernet40" "id" "11"
    redis-cli -n 4 hmset "PORT|Ethernet44" "id" "12"
    redis-cli -n 4 hmset "PORT|Ethernet48" "id" "13"
    redis-cli -n 4 hmset "PORT|Ethernet52" "id" "14"
    redis-cli -n 4 hmset "PORT|Ethernet56" "id" "15"
    redis-cli -n 4 hmset "PORT|Ethernet60" "id" "16"
    redis-cli -n 4 hmset "PORT|Ethernet64" "id" "17"
    redis-cli -n 4 hmset "PORT|Ethernet68" "id" "18"
    redis-cli -n 4 hmset "PORT|Ethernet72" "id" "19"
    redis-cli -n 4 hmset "PORT|Ethernet76" "id" "20"
    redis-cli -n 4 hmset "PORT|Ethernet80" "id" "21"
    redis-cli -n 4 hmset "PORT|Ethernet84" "id" "22"
    redis-cli -n 4 hmset "PORT|Ethernet88" "id" "23"
    redis-cli -n 4 hmset "PORT|Ethernet92" "id" "24"
    redis-cli -n 4 hmset "PORT|Ethernet96" "id" "25"
    redis-cli -n 4 hmset "PORT|Ethernet100" "id" "26"
    redis-cli -n 4 hmset "PORT|Ethernet104" "id" "27"
    redis-cli -n 4 hmset "PORT|Ethernet108" "id" "28"
    redis-cli -n 4 hmset "PORT|Ethernet112" "id" "29"
    redis-cli -n 4 hmset "PORT|Ethernet116" "id" "30"
    redis-cli -n 4 hmset "PORT|Ethernet120" "id" "31"
    redis-cli -n 4 hmset "PORT|Ethernet124" "id" "32"
