...
$(SONIC_KVM_IMAGE)_INSTALLS += $(ALPINE_CONFIG)
$(SONIC_KVM_IMAGE)_INSTALLS += $(ALPINE_INIT)
$(SONIC_KVM_IMAGE)_INSTALLS += $(ALPINE_DEVICE)
...
$(SONIC_KVM_IMAGE)_POST_BUILD_HOOK = platform/alpinevs/src/build/build_alpinevs_docker_save.sh
